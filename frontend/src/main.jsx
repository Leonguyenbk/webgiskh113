...
import ExportGcnMauTanAnPage from "./ExportGcnMauTanAnPage.jsx";
...
function Root() {
  ...
  if (path.startsWith("/tools")) {
    return (
      <ToolsPage
        ...
        onNavigateExportGcnMauTanAn={() => navigate("/xuat-gcn-mau-tanan")}
  ...
  if (path.startsWith("/xuat-gcn-mau-tanan")) {
    return <ExportGcnMauTanAnPage onNavigateHome={() => navigate("/")} />;
  }
